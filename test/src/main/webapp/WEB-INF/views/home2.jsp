...
// 			str+="<td>"+val.kcal+"</td> "
// 			str+="<td>"+val.car+"</td> "
// 			str+="<td>"+val.protein+"</td> "
// 			str+="<td>"+val.fat+"</td> "
// 			str+="<td>"+val.suger+"</td> "
// 			str+="<td>"+val.sodium+"</td> "
// 			str+="<td>"+val.trans_fat+"</td> "
// 			str+="<td>"+val.satuated_fat+"</td> "
// 			str+="<td>"+val.calcium+"</td> "
// 			str+="<td>"+val.fiber+"</td> "
// 			str+="<td>"+val.vit_c+"</td> "
// 			str+="<td>"+val.vit_b1+"</td> "
// 			str+="<td>"+val.vit_b2+"</td> "
// 			str+="<td>"+val.iron+"</td> "
// 			str+="<td>"+val.vit_b2+"</td> "
// 			str+="<tr><br>"
// 		})
